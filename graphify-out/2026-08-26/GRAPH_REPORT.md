# Graph Report - Intake-form  (2026-08-26)

## Corpus Check
- 379 files · ~292,898 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3638 nodes · 4735 edges · 304 communities (235 shown, 69 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 59 edges (avg confidence: 0.64)
...
Cohesion: 0.12
Nodes (22): AuditEvent, DecisionRequest, DecisionResponse, DetailResponse, fetchAnalysisPackage(), fetchAnalysisRuns(), fetchAudit(), fetchIntakeDetail() (+14 more)
...
### Community 2 - "App.tsx"
Cohesion: 0.06
Nodes (44): generateIdempotencyKey(), App(), ASSET_CHECKLIST, ASSET_SERVICES, ASSET_STATUS_OPTIONS, calcPrice(), COLOR_OPTIONS, ColorOption (+36 more)

### Community 3 - "devDependencies"
Cohesion: 0.13
Nodes (15): devDependencies, @playwright/test, @tailwindcss/vite, @testing-library/dom, @testing-library/react, @types/react, @types/react-dom, vite (+7 more)
...
Cohesion: 0.09
Nodes (28): API_BASE_URL, discardIntake(), getIntakeDraft(), lifecycleOp(), rehydrateDraftState(), saveDraft(), submitIntake(), submitIntakeForReview() (+20 more)
...
Cohesion: 0.07
Nodes (47): CompanyAssetsStep(), ReadinessPills(), ResourceReviewBlock(), ADD_ON_SPIEL, AI_AGENT_EXTRA, AI_DECK_EXTRA, CompanyDeckSectionDef, CORE_DECK (+39 more)
...
### Community 14 - "Debug Session: File Uploads Not Going Through"
Cohesion: 0.29
Nodes (6): Debug Session: File Uploads Not Going Through, Fix, Operational Note, Root Cause, Symptoms, Verification
...
### Community 17 - "Query"
Cohesion: 0.11
Nodes (5): binding, makeApp(), Query, state, validUpload
...
### Community 26 - "IntakeDetail.tsx"
Cohesion: 0.12
Nodes (17): fetchQueue(), QueueItem, BuildCardView(), BuildCardViewProps, IntakeDetailViewProps, SECTION_LABELS, SectionId, StatusBadge() (+9 more)
...
Cohesion: 0.08
Nodes (22): AgreementPackage, AgreementStatus, buildAgreementPackage(), DraftContext, nextVersionFor(), BuildCardRow, DecisionRow, EligibilityFailure (+14 more)
...
### Community 50 - "McpStatusPanel.tsx"
Cohesion: 0.14
Nodes (13): McpRun, Icon(), IconName, IconProps, paths, InlineWarning(), InlineWarningProps, Props (+5 more)
...
Cohesion: 0.06
Nodes (33): Ambient Aurora Glow, Border Language, Browser Surface Theming (Aurora scope), Buttons, Cards / Containers (Glass Panels), Colors, Components, Design System: M-THRYVE Intake Form (+25 more)

### Community 90 - "design-tokens-starter.json"
Cohesion: 0.15
...
Cohesion: 0.08
Nodes (28): AuthenticatedClient, AuthenticatedUser, CLIENT_ROLE, ClientRole, Express, INTERNAL_ROLES, Request, requireAuth() (+20 more)
...
### Community 225 - "phase2-copy.mjs"
Cohesion: 0.29
Nodes (5): failures, ORDER, PATCHES, tgtCols, TOKEN
...
### Community 256 - "phase2-verify.mjs"
Cohesion: 0.40
Nodes (5): before, counts(), runSql(), TABLES, TOKEN
...
Cohesion: 0.15
Nodes (12): dependencies, react, react-dom, @supabase/supabase-js, @supabase/supabase-js, name, private, type (+4 more)
...
Cohesion: 0.33
Nodes (3): MAX_RETRIES, appSupabase, state
...
## Knowledge Gaps
- **1653 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `type`, `url`, `enabled` (+1648 more)
...
- **Why does `App()` connect `App.tsx` to `flow.ts`, `inline-validation.integration.test.tsx`, `TemplateFilterPanel.tsx`, `types/intake.ts`, `console-integration.test.tsx`, `data/assets.ts`, `field-validators.ts`, `questionnaire.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `primitive` connect `radius` to `fontSize`, `gray`, `duration`, `spacing`, `design-tokens-starter.json`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `supabase` connect `supabase.ts` to `mcp-orchestration.ts`, `middleware/auth.ts`, `routes/build-orchestration.ts`, `intakes.ts`, `outbox.ts`, `finance.ts`, `portal.ts`, `routes/assets.ts`, `voucher-service.ts`, `build-delivery.ts`?**

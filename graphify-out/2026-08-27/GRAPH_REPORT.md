...
## Corpus Check
- 379 files · ~293,061 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3639 nodes · 4736 edges · 304 communities (234 shown, 70 thin omitted)
...
Cohesion: 0.09
Nodes (21): checkEligibility(), agreementRouter, AGREEMENT_STATUSES, AgreementStatus, applyTransition(), audit(), financeRouter, handleTransition() (+13 more)

### Community 21 - "IntakeDetail.tsx"
Cohesion: 0.14
...
Cohesion: 0.16
Nodes (14): fetchQueue(), QueueItem, BuildCardView(), BuildCardViewProps, ConsoleApp(), StatusBadge(), FILTERS, ReviewQueue() (+6 more)
...
Cohesion: 0.10
Nodes (21): app, config, preflight, configSchema, envFile, getConfig(), getEnvironment(), preflightCheck() (+13 more)
...
Cohesion: 0.11
Nodes (20): AuthenticatedClient, AuthenticatedUser, CLIENT_ROLE, ClientRole, Express, INTERNAL_ROLES, Request, requireAuth() (+12 more)
...
Cohesion: 0.18
Nodes (8): mockFetchAnalysisPackage, mockFetchAnalysisRuns, mockFetchAudit, mockFetchIntakeDetail, mockFetchQueue, mockRetryMcpRun, mockSubmitDecision, QUEUE_ITEMS
...
### Community 279 - "muted-foreground"
Cohesion: 0.67
...
### Community 288 - "primary"
Cohesion: 0.67
Nodes (3): primary, $type, $value

### Community 290 - "primary-hover"
Cohesion: 0.67
...
## Knowledge Gaps
- **1654 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `type`, `url`, `enabled` (+1649 more)
...
- **Why does `App()` connect `App.tsx` to `flow.ts`, `inline-validation.integration.test.tsx`, `TemplateFilterPanel.tsx`, `types/intake.ts`, `data/assets.ts`, `field-validators.ts`, `questionnaire.ts`, `ReviewQueue.tsx`?**
